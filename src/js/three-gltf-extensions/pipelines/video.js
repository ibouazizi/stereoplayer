...
import { COLOR_CODES, VIDEO_STREAM_TYPE } from './constants.js';
import { bufferManager } from '../utils/buffer_manager.js';
import { MP4PullDemuxer } from './demuxer/mp4_pull_demuxer.js';

// Import OpenCV from the worker's location
importScripts(new URL('../third_party/opencv/4.8.0/opencv.js', import.meta.url));
